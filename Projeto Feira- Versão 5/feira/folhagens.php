...
<head>
  ...
  <?php require "produtos_folhagens.php";?>
</head>
...
<table class = "centered">
      ...
      <tbody>
      <?php include('produtos_folhagens.php'); 
      if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
            $imagem = "images/icons/folhagens/".$row['image_produto'];
            ...
            $produto .= "<input type='hidden' id=$idTipo value=$tipo > ";
