...
--
-- Host: 127.0.0.1
-- Tempo de geração: 18/02/2021 às 03:53
...
CREATE TABLE `trabalhe_conosco` (
  ...
  `nome_tc` varchar(255) NOT NULL,
  `endereco_tc` varchar(255) NOT NULL,
  `email_tc` varchar(255) NOT NULL,
  `fone_tc` int(11) NOT NULL,
  `cidade_tc` varchar(255) NOT NULL DEFAULT 'Recife',
  `area_tc` varchar(255) NOT NULL DEFAULT 'Administrativo',
  `exp_tb` varchar(255) NOT NULL,
  `form_tb` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Despejando dados para a tabela `trabalhe_conosco`
--

INSERT INTO `trabalhe_conosco` (`id_tc`, `nome_tc`, `endereco_tc`, `email_tc`, `fone_tc`, `cidade_tc`, `area_tc`, `exp_tb`, `form_tb`) VALUES
(4, 'teste', 'teste', 'teste@gmail.com', 2147483647, 'Recife', 'Administrativo', '', '');
