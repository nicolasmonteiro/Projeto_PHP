  ...
  <nav class="green darken-3" role="navigation">
    ...
    <img src="images/logo/logo.png" width="56" height="56" alt="" title="Select Hortifruti">
      ...
      <!-- Tentei adicionar o nome, antes tinha dado certo, mas depois não consegui, continuarei tentando nas próximas atualizações. -->
        <!--  <li><p>Seja bem vindo (a) <?php echo $_SESSION['nome'] ;?></p></li> -->
      ...
      <div class="row">
        ...
        <div class="col s12 m3">
          <div class="icon-block">
            ...
            <br>
            <p class="center"><img  src="images/icons/folhagens/cebolinha.png" width="49.84" height="49"></p>
            <br>
      ...
      <div class="row">
        ...
        <div class="col l3 s12">
          ...
          <ul>
            ...
            <li><a class="white-text" href="trabalhe.php">Trabalhe Conosco</a></li>
          </ul>
        </div>
      </div>
    </div>
