<!-- <php
session_start();
Este é o arquivo html de cadastro.
?> -->
      ...
      <div class="card center">
        <div class="card-content black-text">
          ...
          <label class="label-input" for="">
              ...
              <input class = 'validate' required = "" type="text" name = "nome" placeholder="Nome">
          </label>
          <br><br>
          <label class="label-input" for="">
              <i class="far fa-envelope icon-modify"></i>
          ...
          <br><br>
          <button type="submit" class="btn btn-second btn-small green darken-3 white-text"  href="#">Cadastrar</button>
          <p class="black-text" href="#">Lembrou?</p>
          <a class="blue-text " href="login.php">Clique aqui para logar</a> 
</form>
